                ...
                <div class="content-wrapper">
                    <div class="row">
                        <div class="col-sm-9 mb-xl-0">
                            <h4 class="font-weight-bold text-dark mb-4">Location</h4>
                        </div>
                        <div class="col-sm-3 mb-xl-0 text-right pb-4">
                            <!-- <a href="add-sport.html" class="btn btn-primary" id="addBtn"><i class="fa fa-plus"></i> Add Location</a> -->
                            <!-- Button trigger modal -->
                            <a  class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalId" >Add Location</a>
                        </div>
                    </div>
                            <!-- Add Modal -->
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="modalTitleId">Location</h5>
                                        ...
                                        <div class="modal-body">
                                            <form method="post" autocomplete="off">
                                                ...
                                                <div class="mb-3">
                                                    <label for="NameLocation" class="form-label text-left">Location</label>
                                                    <input type="text" name="LocationsName" id="NameLocation" class="form-control" placeholder="Enter Location" aria-describedby="helpId" required/>
                                                </div>
                                                <div class="mb-3">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped" id="sportsTable">
                                            ...
                                            <tbody>
                                                <?php 
                                                    $FetchQuery = mysqli_query($db, "SELECT * FROM `master_location` WHERE deletedstatus='0' ORDER BY id DESC");
                                                    $count = 1 ;
                                                    while($read = mysqli_fetch_assoc($FetchQuery)){
                                                ?>
                                                <tr>
                                                    <td><?php echo $count; ?></td>
                                                    <td class="py-1"><?php echo $read['location_name'] ?></td>
                                                    ...
                                                    <div class="modal fade" id="edit-modal-<?php echo $read['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="EditmodalTitleId" aria-hidden="true">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="EditmodalTitleId">Edit <?php echo $read['location_name'] ?></h5>
                                                                    <button type="button" class="btn btn-danger btn-sm" data-bs-dismiss="modal" aria-label="Close"><i class="icon-cross"></i></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <form method="post" autocomplete="off">
                                                                        ...
                                                                        <div class="mb-3">
                                                                            <label for="NameLocations" class="form-label text-left">Name of Sports</label>
                                                                            <input type="text" name="EditLocationName" value="<?php echo $read['location_name'] ?>" id="NameLocations" class="form-control" placeholder="Enter Name of Sports" aria-describedby="helpId" required />
                                                                        </div>
                                                                        <div class="mb-3">
                                                        ...
                                                        <script>
                                                            ...
                                                            function deleteRecord(id) {
                                                                ...
                                                                xhr.open("GET", "delete-locations?delted_id=" + id, true);
                                                                xhr.onload = function() {
